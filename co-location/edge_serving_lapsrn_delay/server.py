...
class FormatData(data_pb2_grpc.FormatDataServicer):
    def DoFormat(self, request, context):
        ...
        index = serving.push_data(start, str, [0, 27, 39], "cuda:0")
    ...
    try:
        while True:
            ...
            if(len(serving.input) == 0):
                ...
                continue
            serving.queue_time = change_waiting_queue(serving.start, serving.queue_time_origin, [0, 27, 39])
