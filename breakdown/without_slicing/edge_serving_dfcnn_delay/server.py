...
class FormatData(data_pb2_grpc.FormatDataServicer):
    def DoFormat(self, request, context):
        ...
        index1 = serving.push_data(start, str, [0], "cuda:0")
        ...
        if(end < 20):
            ...
            serving.push_queue(start1, 0.12, 0.12)
        query_id = serving.get_index()

        serving.prepare_data(start, end, 1, query_id, index1)
    ...
    try:
        while True:
            ...
            if(len(serving.input) == 0):
                ...
                continue
            if(args.method == 'ICE'):
                serving.queue_time = change_waiting_queue(serving.start, serving.queue_time_origin, [0, 0])
